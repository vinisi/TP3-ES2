...
==========
 ...
 Notepad++ ![enter image description here](http://cdn.appstorm.net/windows.appstorm.net/files/2012/05/Notepad-PP-Icon.png "Notepad-PP-Icon.png") é um **editor de texto** de software livre cujo código fonte é aberto sob a licença GPL, é baseado no controle de edição Scintilla e escrito em C++ usando API WIN32 e STL, garantindo uma maior velocidade de execução e um tamanho reduzido do programa.
