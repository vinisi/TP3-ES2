...
==========
 ...
 Notepad++ ![enter image description here]http://i1-win.softpedia-static.com/screenshots/icon-60/Notepad-plus-plus.png "Notepad-plus-plus.pn") é um **editor de texto** de software livre cujo código fonte é aberto sob a licença GPL, é baseado no controle de edição Scintilla e escrito em C++ usando API WIN32 e STL, garantindo uma maior velocidade de execução e um tamanho reduzido do programa.
